 ...
 *  ]
 */
async function v2_getAmountsOut_remote(provider, v2Router02, amountIn, path) {
 ...
 */
async function v2_swapExactTokensForTokens(signer, router02, path, amountIn, amountOutMin, recipient, overrideParams) {
